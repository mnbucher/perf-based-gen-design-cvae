...
class CVAE11(nn.Module):
	...
	def __init__(self, model_config, va):
		...
		self.encoder = Encoder(x_dim+z_g_lowdim, z_dim, y_dim, self.hidden_sizes, n_h, h_context_dim, self.k_flows)
	...
	def forward(self, x, y, z_g):
		...
		z_mu, z_logvar, h_context = self.encoder(x_g, y)
		...
		return recon_x, x_g, kl_divergence, zk
